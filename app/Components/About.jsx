                ...
                <div className='flex-1'>
                    ...
                    <ul className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
                        {infoList.map(({ icon, iconDark, title, description }, index) => (
                            <li className='border-2 border-gray-400 dark:border-gray-600 rounded-xl p-6 cursor-pointer info-card'
                                key={index} >
                    ...
                    <h4 className='my-6 text-gray-700 dark:text-white font-Ovo'>Tools I use</h4>
                    
                    <ul className='flex items-center gap-3 sm:gap-5'>
                        {toolsData.map((tool, index) => (
                            <li key={index} className='flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 dark:border-gray-600 rounded-lg cursor-pointer hover:-translate-y-1 hover:border-black dark:hover:border-white hover:border-2 hover:shadow-lg duration-500'>
