    ...
    return (
        <div className='w-11/12 max-w-3xl text-center mx-auto min-h-screen flex flex-col items-center justify-center gap-4 pt-20 pb-10'>
            ...
            <h3 className='flex items-center justify-center gap-2 text-xl md:text-2xl mb-3 font-Ovo'>
                Hi! I'm Sayyda Ifrah <Image src={assets.hand_icon} alt="Hand" className='w-6 object-cover' />
            </h3>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 sm:gap-6 mt-4'>
                <a href='#contact'
                className='px-10 py-3 bg-black text-white rounded-full flex items-center gap-2 hover:bg-darkHover duration-500 font-Ovo'>
                    contact me <Image src={assets.right_arrow_white} alt="Right Arrow" className='w-4' />
                </a>
                <a href='/resume.pdf' download className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 hover:bg-lightHover duration-500 font-Ovo'>
